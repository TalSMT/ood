...
public class Gui_Data {
	...
	//-----------------parameters-------------------------------
	public static String combName = "\\DataNetWorks.csv";
	...
	public static ArrayList<SampleOfWifi> processedCsvFile;
	//------read comb----
	...
	private void initialize() {
		frame = new JFrame();
		//Image img= new	ImageIcon(this.getClass().getResource("\black_background1.png")).getImage();
